	...
	return (
		<View className='flex-1'>
			<View className='py-12 md:py-24 lg:py-32 xl:py-48'>
				<View className='bg-green-200 px-4 md:px-6'>
					<View className='flex flex-col items-center gap-4 text-center'>
						<Text
							role='heading'
							className='native:text-5xl bg-red-900 text-center text-3xl font-bold tracking-tighter text-cyan-300 sm:text-4xl md:text-5xl lg:text-6xl'
						>
						...
						<View className='gap-4'>
							<Link
								...
								className='web:shadow ios:shadow web:focus-visible:outline-none web:focus-visible:ring-1 flex h-9 items-center justify-center overflow-hidden rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-gray-50 transition-colors hover:bg-gray-900/90 focus-visible:ring-gray-950 active:bg-gray-400/90 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300'
								href='/'
							>
								Explore
							</Link>
		...
		<View style={{ paddingTop: top }}>
			<View className='flex h-14 flex-row items-center justify-between px-4 lg:px-6'>
				...
				<View className='flex flex-row gap-4 sm:gap-6'>
					<Link className='text-md web:underline-offset-4 font-medium hover:underline' href='/'>
						About
					</Link>
					<Link className='text-md web:underline-offset-4 font-medium hover:underline' href='/'>
						Product
...
function Footer() {
	...
	return (
		<View className='native:hidden flex shrink-0 bg-gray-100' style={{ paddingBottom: bottom }}>
